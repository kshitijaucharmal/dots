...
random_wallpaper = "/home/kshitij/.scripts/chwal"

@hook.subscribe.startup_once
def autostart():
	home = os.path.expanduser("~/.scripts/autostart")
	qtile_specific = os.path.expanduser("~/.config/qtile/autostart.sh")
	subprocess.call([home])
	subprocess.call([qtile_specific])
...
keys = [
    ...
    EK("M-r", lazy.spawn(random_wallpaper)),
    EK("M-S-r", lazy.spawn("redshift -x")),

    # rofi launcher
    EK("C-<space>",  lazy.spawn(launcher)),
    ...
    EK("M-S-<Right>", lazy.spawn("amixer -D pulse sset Master 2%+")),
    EK("M-S-<Left>", lazy.spawn("amixer -D pulse sset Master 2%-")),
