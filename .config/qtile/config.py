...
terminal = "kitty -c=/home/kshitij/.config/kitty/kittytmux.conf"
terminal2 = "kitty"
...
keys = [
    ...
    EK("M-r", lazy.spawn("/home/kshitij/.scripts/chwal")),
    EK("M-S-r", lazy.spawn("redshift -O 5000")),
    EK("M-C-r", lazy.spawn("redshift -x")),
    # rofi launcher
    EK(
        "C-<space>",
        lazy.spawn(
            'rofi -show-icons -show drun -display-drun "" -font "FiraCode Nerd Font 12"'
        ),
    ),
